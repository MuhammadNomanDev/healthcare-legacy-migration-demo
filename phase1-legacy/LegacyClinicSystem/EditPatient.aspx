<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EditPatient.aspx.cs" Inherits="LegacyClinicSystem.EditPatient" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update Patient" CssClass="btn btn-primary" OnClick="btnUpdate_Click" />
                </div>
            </div>
        </div>
